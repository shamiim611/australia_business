...
data=json.loads((ROOT/'data/dashboard-2013-14.json').read_text(encoding='utf-8'))
...
assert 'Australian sources' not in by['2-4']['headers'][4]['label']
...
assert by['4-1']['headers'][12]['measure']=='social media presence'
assert by['4-1']['headers'][12]['population']=='All businesses'
